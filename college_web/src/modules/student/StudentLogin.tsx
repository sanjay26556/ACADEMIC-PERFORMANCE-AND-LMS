...
const StudentLogin = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(34,197,94,0.15),rgba(255,255,255,0))] p-4">
            ...
            <Card className="w-full max-w-md shadow-2xl border-neutral-800 bg-neutral-900/50 backdrop-blur-xl">
                <CardHeader className="space-y-1 pb-2">
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-6 p-1 bg-neutral-950/50 rounded-lg border border-neutral-800">
                        <Button variant="ghost" className="bg-neutral-800 text-green-400 shadow-sm">Student</Button>
                        <Link to="/lms/teacher/login">
                            <Button variant="ghost" className="w-full text-neutral-400 hover:text-amber-400 hover:bg-neutral-800/50">Teacher</Button>
                        </Link>
